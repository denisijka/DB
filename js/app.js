 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (exampleSliders.length) exampleSliders.forEach((slide => {
                const paging = slide.querySelector(".examples-pagination-bullets");
                new core(slide, {
                    modules: [ Pagination ],
                    observer: true,
                    observeParents: true,
            ...
            if (document.querySelector(".gallery-details__slider")) new core(".gallery-details__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                loop: true,
                pagination: {
                    el: ".gallery-details-pagination-bullets",
                    clickable: true
                },
                breakpoints: {
                    320: {
            ...
            if (document.querySelector(".introduce__slider")) new core(".introduce__slider", {
                ...
                thumbs: {
                    swiper: {
                        el: ".interested__slider",
                        slidesPerView: 3
                    }
                },
                pagination: {
                    el: ".introduce-pagination-bullets",
                    clickable: true
                },
                on: {}
            });
